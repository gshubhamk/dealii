...
public:
  ...
  loop_cell_centric_CAA(
    ...
    dealii::TimerOutput &timer = nullptr) const;          // edit by VD & SKG
  ...
  dealii::TimerOutput &timer) const // SKG-timer: add timer here
{
  ...
  task_info.loop(worker, this->communication, PE_boundary_indicator, timer);
}
